...
<table>
    ...
    <tbody>
        <tr>
            <td>
                500+ integrations (Instant Observability and quickstarts, except curated views)
            </td>
            <td>
